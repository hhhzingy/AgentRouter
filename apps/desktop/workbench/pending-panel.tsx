...
export function LocalDataPanel(){
 ...
 const keys=typeof localStorage==='undefined'?[]:Object.keys(localStorage).filter(k=>k.startsWith('agentrouter.pending:')||k.startsWith('agentrouter.pending-migration-backup:')||k.startsWith('agentrouter.task-draft:'));

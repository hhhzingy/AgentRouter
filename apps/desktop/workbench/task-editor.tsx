...
function DraftFields({storageKey,role,mode,task}:{storageKey:string;role:RoleVM;mode:'NEW_TASK'|'TASK_INPUT';task?:TaskVM}){
 ...
 {state==='uncertain'&&<p className="hint tone-warning">旧操作仍在待核对列表。修改内容是新意图，不会删除或取消旧操作。</p>}

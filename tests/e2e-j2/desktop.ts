...
try{
 ...
 await core?.stop();writeFileSync('evidence/J2/desktop.json',JSON.stringify({sourceSha,mode:'REAL_ELECTRON_LOCAL_CORE',realHarnessSupport:0,nativeDialogs:'CONTROLLED_RETURN_MANUAL_NOT_RUN',checks,screenshots},null,2)+'\n');
}

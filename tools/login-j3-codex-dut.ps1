...
$dutRoot = Join-Path $repoRoot '.local-protected\codex-dut\dut-fj'
...
try {
    ...
    Write-Host 'Login ONLY the isolated AgentRouter DUT dut-fj. Keep the Codex desktop account unchanged.'

...
| 本轮产品修复 SHA | `8c6f84e34dba5e6a47dfc416de127562073d8ae8`；其后仅修改测试接入与测试断言，最终已测试/打包源码 SHA 为 `8be447b405bc86827a5206787ab99f755227c8ae`，已推送 GitHub；本文为文档后继提交，不冒充包内 SHA |
...
5. `8be447b` 的真实 Tailnet 后端已通过，但实体手机浏览器控制/观察者、屏幕阅读器与 DPI 逐页验收未完成；本机 Chrome 手机尺寸和 Windows CI Electron J1/J2 不能替代。此前同 Harness 历史完整迁移证据也尚未在最终 Core/UI 合流包逐项复跑。
